...
#define UE_PROJECT_NAME Vingt_mille
#define UE_TARGET_NAME Vingt_milleEditor
...
#define SUPPORTS_COMMANDLET 1
#define ENABLE_AUTO_CLEAN_NNATCLASS 1
#define ENABLE_TYPE_CHECK 1
#define UNLUA_ENABLE_DEBUG 0
#define UNLUA_API DLLIMPORT
#define XDGAMEPLUGIN_API DLLEXPORT
